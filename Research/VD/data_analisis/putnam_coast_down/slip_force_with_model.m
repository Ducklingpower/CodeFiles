...
%% fig 5 - Fx vs slip ratio (tire, modeled)
...
Fy_fl = Fyf .* (Fz_fl_eff ./ Fz_front);
Fy_fr = Fyf .* (Fz_fr_eff ./ Fz_front);
Fy_rl = Fyr .* (Fz_rl_eff ./ Fz_rear);
Fy_rr = Fyr .* (Fz_rr_eff ./ Fz_rear);

%% fig 8 - paper method (measured)
figure('Name','Fig 8 - Paper Method (measured Fx)');

subplot(2,2,1)
plotPaper(S_fl, hypot(fx_fl, Fy_fl), Fz_fl_eff, t, vx, Fz_min_paper, vx_min_slip_angle);
subplot(2,2,2)
plotPaper(S_fr, hypot(fx_fr, Fy_fr), Fz_fr_eff, t, vx, Fz_min_paper, vx_min_slip_angle);
subplot(2,2,3)
plotPaper(S_rl, hypot(fx_rl, Fy_rl), Fz_rl_eff, t, vx, Fz_min_paper, vx_min_slip_angle);
subplot(2,2,4)
plotPaper(S_rr, hypot(fx_rr, Fy_rr), Fz_rr_eff, t, vx, Fz_min_paper, vx_min_slip_angle);

%% fig 9 - paper method (modeled)
figure('Name','Fig 9 - Paper Method (modeled Fx)');

subplot(2,2,1)
plotPaper(S_fl, hypot(fx_fl_model, Fy_fl), Fz_fl_eff, t, vx, Fz_min_paper, vx_min_slip_angle);
subplot(2,2,2)
plotPaper(S_fr, hypot(fx_fr_model, Fy_fr), Fz_fr_eff, t, vx, Fz_min_paper, vx_min_slip_angle);
subplot(2,2,3)
plotPaper(S_rl, hypot(fx_rl_model, Fy_rl), Fz_rl_eff, t, vx, Fz_min_paper, vx_min_slip_angle);
subplot(2,2,4)
plotPaper(S_rr, hypot(fx_rr_model, Fy_rr), Fz_rr_eff, t, vx, Fz_min_paper, vx_min_slip_angle);

%% fig 10 - rear Fx measured vs modeled
...
%% functions
function plotPaper(S, F, Fz_eff, tv, vx, Fz_min, vx_min)
    Fn = F ./ Fz_eff;
