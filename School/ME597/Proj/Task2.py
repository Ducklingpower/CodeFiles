...
class tracker(Node):
    ...
    def __init__(self):
        ...
        #self.sub = self.create_subscription(ImageCV2,'/camera/image_raw',10)
 ...
 ############################################################## Def for Astar path follwoing ##################################################################################################
    ...
    def searching(self):
        ...
        if not self._have_goal:
            ...
            return   # wait until have goal pos
        ...
        if self.first_iter:
            ...
            self._last_idx = 0
            self.get_logger().info("first itter")
