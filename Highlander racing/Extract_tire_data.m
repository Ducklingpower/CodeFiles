function [ AMBTMP, ET, FX, FY, FZ, IA, MX, MZ, N, NFX, NFY, P, RE, RL, RST, SA, SR, TSTC, TSTI, TSTO, V] = Extract_tire_data( fileid )
%extacting all of the tire data and assigning varible names *.dat
