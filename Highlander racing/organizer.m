function [xxx,xxx_reject]= organizer(y)



counter = 0;
A=zeros(1000,1);
xx1= zeros(length(y),1);
xx2= zeros(length(y),1);
xx3= zeros(length(y),1);
xx4= zeros(length(y),1);
xx5= zeros(length(y),1);
xx6= zeros(length(y),1);
xx7= zeros(length(y),1);
xx8= zeros(length(y),1);
xx9= zeros(length(y),1);
xx10= zeros(length(y),1);
xx11= zeros(length(y),1);
xx12= zeros(length(y),1);
xx13= zeros(length(y),1);
xx14= zeros(length(y),1);
xx15= zeros(length(y),1);
xx16= zeros(length(y),1);


xxx = zeros(length(y),100);%this will hold data for each graph
xxn = zeros(length(y),100);
...
if n1==0
    ...
    if n1 ==0
        break
            ...
            for j = 0:length(y)-position                  %%iterate backwards
          ...
          if i ==1
               xx1(position-j)= y(position-j); 
                
          elseif i==2
               xx2(position-j)= y(position-j);
          elseif i==3
               xx3(position-j)= y(position-j);
          elseif i==4
               xx4(position-j)= y(position-j);
          elseif i==5
               xx5(position-j)= y(position-j);
          elseif i==6
               xx6(position-j)= y(position-j);
          elseif i==7
               xx7(position-j)= y(position-j);
          elseif i==8
               xx8(position-j)= y(position-j);
          elseif i==9
               xx9(position-j)= y(position-j);
          elseif i==10
               xx10(position-j)= y(position-j);
          elseif i==11
               xx11(position-j)= y(position-j);
          elseif i==12
               xx12(position-j)= y(position-j);
          elseif i==13
               xx13(position-j)= y(position-j);
          elseif i==14
               xx14(position-j)= y(position-j);
          elseif i==15
               xx15(position-j)= y(position-j);
          elseif i==16
               xx16(position-j)= y(position-j);
          else
              
          end
 xxx(position-j,i) = y(position-j);
...
counter=0;
             ...
             for j = 0:length(y)-position 
                    
                 if position+j+13>=length(y)
                 break
                 else
  ...
  xxx(position+j,i) = y(position+j);%% filling in matrix xxx with values
...
%%%%%%%%%%%%%%%%%%%%%final final check 
xxx_reject = zeros(length(y),100);
zero_matrix =zeros(length(y),100);
